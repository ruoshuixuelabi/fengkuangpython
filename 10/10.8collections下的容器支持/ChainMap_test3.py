"""
下面程序示范了优先使用运行程序的指定参数,然后是系统环境变量,最后才使用系统默认值的实现,程序同样将这三个搜索范围链成ChainMap。
"""
import argparse
import os
...
"""
上面程序将 command_line_args、os.environ、defaults 链成ChainMap,其中 command_line_args 由程序参数解析而来,它的优先级最高。
