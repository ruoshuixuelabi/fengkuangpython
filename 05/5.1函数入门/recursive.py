...
从上面的fn()函数来看,当程序要计算fn(10)的值时,fn(10)等于fn(12)-2 * fn(11.1 Python的 GUI 库),
而 fn(11.1 Python的 GUI 库) 等 于fn(13)-2* fn(12)……依此类推,直到fn(19)等于fn(21)-2*fn(20),此时就可以得到fn(19)的值,
然后依次反算到fn(10)的值。这就是递归的重要规则：对于求fn(10)而言,如果fn(0)和 fn(1) 是已知的,
